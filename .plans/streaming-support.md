# Streaming LLM Response Support for BlackMagicBox Encover Agent
...
```
BMB_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("BMB_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `bmb_cli/config.py` | 1 | +streaming config defaults |
