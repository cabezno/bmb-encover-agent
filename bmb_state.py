#!/usr/bin/env python3
"""
SQLite State Store for BlackMagicBox Encover Agent.
...
DEFAULT_DB_PATH = get_bmb_home() / "state.db"
...
class SessionDB:
    ...
    # With multiple bmb processes (gateway + CLI sessions + worktree agents)
