...
import type { ScrollBoxHandle } from '@bmb/ink'
import { evictInkCaches } from '@bmb/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.BMB_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
