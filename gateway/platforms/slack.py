...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        tokens_file = get_bmb_home() / "slack_tokens.json"
        ...
        try:
            ...
            # /model work directly without /bmb prefix). A single regex
            ...
            # manifest (see `bmb slack manifest`). In Socket Mode, Slack
            ...
            from bmb_cli.commands import slack_native_slashes
            import re as _re
                    ...
                    "elements": [
                        {
                            ...
                            "style": "primary",
                            "action_id": "bmb_approve_once",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Allow Session"},
                            "action_id": "bmb_approve_session",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Always Allow"},
                            "action_id": "bmb_approve_always",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                    ...
                    "elements": [
                        {
                            ...
                            "style": "primary",
                            "action_id": "bmb_confirm_once",
                            "value": value,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Always Approve"},
                            "action_id": "bmb_confirm_always",
                            "value": value,
                        },
                        {
                            "type": "button",
    ...
    async def _handle_slash_confirm_action(self, ack, body, action) -> None:
        ...
        choice_map = {
            "bmb_confirm_once": "once",
            "bmb_confirm_always": "always",
            "bmb_confirm_cancel": "cancel",
        }
    ...
    async def _handle_approval_action(self, ack, body, action) -> None:
        ...
        choice_map = {
            "bmb_approve_once": "once",
            "bmb_approve_session": "session",
            "bmb_approve_always": "always",
            "bmb_deny": "deny",
        }
    ...
    async def _handle_slash_command(self, command: dict) -> None:
        ...
        if slash_name in ("bmb", ""):
            # Legacy /bmb <subcommand> [args] routing + free-form questions.
            # Empty slash_name falls into this branch for backward compat
            # with any caller that didn't populate command["command"].
            from bmb_cli.commands import slack_subcommand_map
        ...
        # questions via "/bmb <question>" must produce public replies so
