...
Config: ~/.bmb/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.bmb/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_bmb_home()`` helper (BMB_ENCOVER_HOME-aware and
...
RULES_FILE = get_bmb_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_bmb_home() / "feishu_comment_pairing.json"
