...
GATEWAY_SECRET_CAPTURE_UNSUPPORTED_MESSAGE = (
    ...
    "Load this skill in the local CLI to be prompted, or add the key to ~/.bmb/.env manually."
)
...
# Default location: {BMB_ENCOVER_HOME}/cache/images/ (legacy: image_cache/)
IMAGE_CACHE_DIR = get_bmb_dir("cache/images", "image_cache")
...
AUDIO_CACHE_DIR = get_bmb_dir("cache/audio", "audio_cache")
...
VIDEO_CACHE_DIR = get_bmb_dir("cache/videos", "video_cache")
...
DOCUMENT_CACHE_DIR = get_bmb_dir("cache/documents", "document_cache")
...
class BasePlatformAdapter(ABC):
    ...
    async def handle_message(self, event: MessageEvent) -> None:
        ...
        if session_key in self._active_sessions:
            ...
            from bmb_cli.commands import should_bypass_active_session
    ...
    async def _process_message_background(self, event: MessageEvent, session_key: str) -> None:
        ...
        try:
            ...
            # not at the top of this task.  _bmb_run_generation is set on
