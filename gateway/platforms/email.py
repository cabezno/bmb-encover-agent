"""
Email platform adapter for the BMB gateway.

Allows users to interact with BMB by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "BlackMagicBox Encover Agent")
        ...
        msg_id = f"<bmb-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
