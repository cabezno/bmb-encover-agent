...
2. **Per-result persistence** (maybe_persist_tool_result): After a tool
   ...
   SANDBOX temp dir (for example /tmp/bmb-results/{tool_use_id}.txt on
   standard Linux, or $TMPDIR/bmb-results/{tool_use_id}.txt on Termux)
...
STORAGE_DIR = "/tmp/bmb-results"
HEREDOC_MARKER = "BMB_PERSIST_EOF"
...
def _heredoc_marker(content: str) -> str:
    ...
    return f"BMB_PERSIST_{uuid.uuid4().hex[:8]}"
