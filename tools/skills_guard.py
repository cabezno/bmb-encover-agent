...
Trust levels:
  - builtin:   Ships with BMB. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.bmb/\.env|\~/\.bmb/\.env',
     "bmb_env_access", "critical", "exfiltration",
     "directly references BMB secrets file"),
    ...
    (r'\.bmb/config\.yaml|\.bmb/SOUL\.md',
     "bmb_config_mod", "critical", "persistence",
     "references BMB configuration files directly"),
