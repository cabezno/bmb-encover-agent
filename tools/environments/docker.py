...
def _load_hermes_env_vars() -> dict[str, str]:
    """Load ~/.bmb/.env values without failing Docker command execution."""
    try:
        from bmb_cli.config import load_env
...
#   SETUID/SETGID - the image entrypoint drops from root to the 'bmb'
...
class DockerEnvironment(BaseEnvironment):
    ...
    def __init__(
        ...
        # (TERMINAL_SANDBOX_DIR, default ~/.bmb/sandboxes/). Non-persistent
