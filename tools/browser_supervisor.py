...
One ``CDPSupervisor`` runs per BMB ``task_id`` that has a reachable CDP
...
DIALOG_BRIDGE_HOST = "bmb-dialog-bridge.invalid"
...
(() => {
  ...
  const ENDPOINT = "http://bmb-dialog-bridge.invalid/";
