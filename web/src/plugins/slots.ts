 ...
 * `window.__BMB_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the BMB brand in the top bar
 ...
 *  `window.__BMB_PLUGINS__.registerSlot(...)`.
 *
