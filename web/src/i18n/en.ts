...
export const en: Translations = {
  ...
  app: {
    brand: "BlackMagicBox Encover Agent",
    brandShort: "HA",
  ...
  pluginsPage: {
    ...
    removeConfirm: "Remove this plugin from ~/.bmb/plugins/?",
    removeHint: "Only user-installed plugins under ~/.bmb/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.bmb/skills/",
