...
const STORAGE_KEY = "bmb-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `bmb_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "bmb-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-bmb-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-bmb-theme-font", "true");
