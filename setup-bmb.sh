#!/bin/bash
# ============================================================================
# BlackMagicBox Encover Agent Setup Script
# ============================================================================
...
echo ""
echo -e "${CYAN}⚕ BlackMagicBox Encover Agent Setup${NC}"
echo ""
...
# ============================================================================
# PATH setup — symlink bmb into a user-facing bin dir
# ============================================================================
...
echo "Other commands:"
echo "  bmb status        # Check configuration"
if is_termux; then
    echo "  bmb gateway       # Run gateway in foreground"
else
    echo "  bmb gateway install # Install gateway service (messaging + cron)"
fi
echo "  bmb cron list     # View scheduled jobs"
echo "  bmb doctor        # Diagnose issues"
echo ""
...
if [[ $REPLY =~ ^[Yy]$ ]] || [[ -z $REPLY ]]; then
    ...
    "$SCRIPT_DIR/venv/bin/python" -m bmb_cli.main setup
fi
