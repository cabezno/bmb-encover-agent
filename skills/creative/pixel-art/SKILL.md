...
```python
import sys
sys.path.insert(0, "/home/teknium/.bmb/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.bmb/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — BMB installs package this)
