...
## BlackMagicBox Encover Agent Integration

This skill is designed for the BMB agent. It uses BMB tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other BMB skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.bmb/plans/` | `skill_view("plan")` |
