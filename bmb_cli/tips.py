...
TIPS = [
    ...
    "bmb mcp serve runs Hermes itself as an MCP server for other agents.",
    ...
    "bmb backup creates a zip backup of your entire Hermes home directory.",
    ...
    "bmb gateway install sets up Hermes as a system service (systemd/launchd).",
    ...
    "bmb acp runs Hermes as an ACP server for VS Code, Zed, and JetBrains integration.",
