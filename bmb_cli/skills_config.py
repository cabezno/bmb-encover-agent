"""
Skills configuration for BlackMagicBox Encover Agent.
`bmb skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.bmb/config.yaml under:
...
from bmb_cli.config import cfg_get, load_config, save_config
from bmb_cli.colors import Colors, color
from bmb_cli.platforms import PLATFORMS as _PLATFORMS
