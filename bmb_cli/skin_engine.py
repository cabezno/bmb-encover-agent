...
.. code-block:: yaml
    ...
    branding:
      agent_name: "BlackMagicBox Encover Agent"          # Banner title, status display
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "BlackMagicBox Encover Agent"
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        "branding": {
            "agent_name": "BlackMagicBox Encover Agent",
            "welcome": "Welcome to BlackMagicBox Encover Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
