"""BMB CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.bmb/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "BMB Undercover Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ BMB "       # Response box header label
...
.. code-block:: python
    ...
    from bmb_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "BMB Undercover Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.bmb/skins/

BUILT-IN SKINS
==============

- ``default`` — Default BMB (dark tech green)
...
Drop a YAML file in ``~/.bmb/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces BMB_ENCOVER_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces BMB_BLACK_BOX)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Default BMB — dark tech green",
        "colors": {
        ...
        "branding": {
            "agent_name": "BMB Undercover Agent",
            "welcome": "Welcome to BMB Undercover Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ BMB ",
            "prompt_symbol": "❯",
...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "soda": {
        "name": "soda",
        "description": "Dark IDE & SODA style — high-contrast industrial terminal",
        "colors": {
            ...
            "prompt": "#D4D4D4",
            "input_rule": "#1C1C1C",
            "response_border": "#2E2E2E",
            "status_bar_bg": "#080808",
            "status_bar_text": "#666666",
            "status_bar_strong": "#F0F0F0",
            "status_bar_dim": "#3A3A3A",
            "status_bar_good": "#22C55E",
            "status_bar_warn": "#F59E0B",
            "status_bar_bad": "#EF4444",
            "status_bar_critical": "#EF4444",
            "session_label": "#666666",
            "session_border": "#1C1C1C",
        },
        "spinner": {
            "thinking_verbs": ["compiling", "executing", "parsing", "querying", "processing"],
            "waiting_faces": ["(•)", "[•]", "{•}"],
            "thinking_faces": ["(•)", "[•]", "{•}"],
        },
        "branding": {
            "agent_name": "BMB Soda Agent",
            "welcome": "Welcome to BMB Soda Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ SODA ",
            "prompt_symbol": "❯",
            "help_header": "[?] Available Commands",
