...
# load_bmb_dotenv() calls (user env + project env, gateway hot-reload,
...
def _sanitize_loaded_credentials() -> None:
    ...
    for key, value in list(os.environ.items()):
        ...
        print(
            ...
            "  provider's dashboard and run `bmb setup` (or edit the "
...
def _sanitize_env_file_if_needed(path: Path) -> None:
    ...
    if not path.exists():
        return
    try:
        from bmb_cli.config import _sanitize_env_lines
    except ImportError:
