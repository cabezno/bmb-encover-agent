"""Shell completion script generation for bmb CLI.
...
def generate_bash(parser: argparse.ArgumentParser) -> str:
    ...
    return f"""# BlackMagicBox Encover Agent bash completion
# Add to ~/.bashrc:
...
# BlackMagicBox Encover Agent zsh completion
# Add to ~/.zshrc:
...
def generate_fish(parser: argparse.ArgumentParser) -> str:
    ...
    lines: list[str] = [
        "# BlackMagicBox Encover Agent fish completion",
        "# Add to your config:",
        "#   bmb completion fish | source",
        "",
        "# Helper: list available profiles",
        "function __hermes_profiles",
        "    echo default",
        "    if test -d $HOME/.bmb/profiles",
        "        ls $HOME/.bmb/profiles 2>/dev/null",
        "    end",
        "end",
        "",
        ...
        "",
        "# Complete profile names after -p / --profile",
        "complete -c bmb -f -s p -l profile"
