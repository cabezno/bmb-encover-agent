...
Usage:
    bmb pairing list              # Show all pending + approved users
    bmb pairing approve <platform> <code>  # Approve a pairing code
    bmb pairing revoke <platform> <user_id> # Revoke user access
    bmb pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle bmb pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: bmb pairing {list|approve|revoke|clear-pending}")
        print("Run 'bmb pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'bmb pairing list' to see pending codes.\n")
