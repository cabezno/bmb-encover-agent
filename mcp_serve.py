...
def _get_sessions_dir() -> Path:
    """Return the sessions directory using BMB_ENCOVER_HOME."""
    try:
...
def create_mcp_server(event_bridge: Optional[EventBridge] = None) -> "FastMCP":
    ...
    mcp = FastMCP(
        "bmb",
        instructions=(
            "BlackMagicBox Encover Agent messaging bridge. Use these tools to interact with "
