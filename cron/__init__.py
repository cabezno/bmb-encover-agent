"""
Cron job scheduling system for BlackMagicBox Encover Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    bmb gateway install    # Install as a user service
    sudo bmb gateway install --system  # Linux servers: boot-time system service
    bmb gateway            # Or run in foreground
