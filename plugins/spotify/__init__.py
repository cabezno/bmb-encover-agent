...
``_check_spotify_available()`` — when the user has not run ``bmb auth
spotify``, the tools remain registered (so they appear in ``bmb
...
The Spotify auth flow (``bmb auth spotify``), CLI plumbing, and docs
