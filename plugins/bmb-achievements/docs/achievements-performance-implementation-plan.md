# BMB Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.bmb/plugins/bmb-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.bmb/plugins/bmb-achievements/scan_checkpoint.json`.
