# BMB Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.bmb/plugins/bmb-achievements/state.json` (existing unlock state)
  - `~/.bmb/plugins/bmb-achievements/scan_snapshot.json` (new)
  - `~/.bmb/plugins/bmb-achievements/scan_checkpoint.json` (new)
