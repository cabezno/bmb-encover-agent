...
>
> When Hermes is installed via `pip install bmb-encover` or cloned from source, this plugin auto-registers as a dashboard tab on first `bmb dashboard` launch. No separate install step. See [Built-in Plugins → bmb-achievements](../../website/docs/user-guide/features/built-in-plugins.md) in the main docs.
