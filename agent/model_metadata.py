...
# Minimum context length required to run BlackMagicBox Encover Agent.  Models with fewer
...
_URL_TO_PROVIDER: Dict[str, str] = {
    ...
    "inference-api.blackmagicbox.com": "nous",
...
def _get_context_cache_path() -> Path:
    ...
    return get_bmb_home() / "context_length_cache.yaml"
...
def get_model_context_length(
    ...
    if effective_provider in ("copilot", "copilot-acp", "github-copilot"):
        try:
            from bmb_cli.models import get_copilot_model_context
