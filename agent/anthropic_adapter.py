    ...
    *base_url* is a Kimi / Moonshot host), unsigned thinking blocks
    ...
    for m in messages:
        ...
        if role == "assistant":
            ...
            # can validate the message history.  See bmb-encover#13848.
            #
    ...
    # are preserved.  See bmb-encover#13848 (Kimi) and #16748 (DeepSeek).
