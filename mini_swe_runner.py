#!/usr/bin/env python3
"""
SWE Runner with BMB Trajectory Format

A runner that uses BMB-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the BMB-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses BMB-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in BMB format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches BMB-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using BMB-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with BMB Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses BMB-Agent's built-in execution environments
    and outputs trajectories in BMB-Agent format.
    """
    ...
    def _convert_to_hermes_format(
        ...
        """
        Convert internal message format to BMB trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to BMB trajectory format
...
def main(
    ...
    """
    Run SWE tasks with BMB trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with BMB Trajectory Format")
    print("=" * 60)
