...
DEFAULT_DATASETS = [
    "Encover/swe-terminus-agent-glm-kimi-minimax",
    "Encover/bmb-encover-megascience-sft1",
    "Encover/Hermes-Agent-Thinking-GLM-4.7-SFT2",
    "Encover/Hermes-Agent-Thinking-GLM-4.7-SFT1",
    "Encover/terminal-tasks-glm-bmb-encover"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "Encover/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload Encover/{output_name} {final_output}")
