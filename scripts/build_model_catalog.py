#!/usr/bin/env python3
"""Build the BMB Model Catalog — a centralized JSON manifest of curated models.
...
BMB CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a BMB release.
...
``https://bmb-encover.blackmagicbox.com/docs/api/model-catalog.json``
"""
...
# Ensure BMB_ENCOVER_HOME is set for imports that touch it at module level.
os.environ.setdefault("BMB_ENCOVER_HOME", os.path.join(os.path.expanduser("~"), ".bmb"))

from bmb_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "bmb-encover repo",
            "docs": "https://bmb-encover.blackmagicbox.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
