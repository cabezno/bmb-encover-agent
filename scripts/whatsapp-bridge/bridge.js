#!/usr/bin/env node
/**
 * BlackMagicBox Encover Agent WhatsApp Bridge
 *
 ...
 *
 * Usage:
 *   node bridge.js --port 3000 --session ~/.bmb/whatsapp/session
 */
...
const DEFAULT_REPLY_PREFIX = '⚕ *BlackMagicBox Encover Agent*\n────────────\n';
...
async function startSocket() {
  ...
  sock = makeWASocket({
    ...
    browser: ['BlackMagicBox Encover Agent', 'Chrome', '120.0'],
