#!/usr/bin/env python3
"""BlackMagicBox Encover Agent Release Script
...
VERSION_FILE = REPO_ROOT / "bmb_cli" / "__init__.py"
...
AUTHOR_MAP = {
    ...
    "teknium@blackmagicbox.com": "teknium1",
    ...
    "274096618+bmb-encover-dhabibi@users.noreply.github.com": "dhabibi",
    ...
    "shannon@blackmagicbox.com": "shannonsands",
    ...
    "ben@blackmagicbox.com": "benbarclay",
    ...
    "emozilla@blackmagicbox.com": "emozilla",
    ...
    "jonny@blackmagicbox.com": "jquesnelle",
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/Encover/bmb-encover",
    ...
    lines.append(f"# BlackMagicBox Encover Agent v{semver} ({tag_name})")
    lines.append("")
    ...
    if first_release:
        ...
        lines.append("> for BlackMagicBox Encover Agent. See below for everything included in this initial release.")
        lines.append("")
...
def main():
    parser = argparse.ArgumentParser(description="BlackMagicBox Encover Agent Release Tool")
    ...
    print(f"{'='*60}")
    print(f"  BlackMagicBox Encover Agent Release Preview")
    print(f"{'='*60}")
    ...
    if args.publish:
        ...
        tag_result = git_result(
            "tag", "-a", tag_name, "-m",
            f"BlackMagicBox Encover Agent v{new_version} ({calver_date})\n\nWeekly release"
        )
        ...
        gh_cmd = [
            ...
            "--title", f"BlackMagicBox Encover Agent v{new_version} ({calver_date})",
        ...
        if result and result.returncode == 0:
            ...
            print(
                f"    gh release create {tag_name} --title 'BlackMagicBox Encover Agent v{new_version} ({calver_date})' "
