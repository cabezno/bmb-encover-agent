#!/usr/bin/env python3
"""Build the BMB Skills Index — a centralized JSON catalog of all skills.
...
`bmb skills search/install` can use it without hitting the GitHub API.
...
# Ensure BMB_ENCOVER_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building BMB Skills Index...", flush=True)
